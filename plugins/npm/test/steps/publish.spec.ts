...
describe("publish", () => {
  ...
  it("should publish the package with pnpm", async () => {
    const cwd = temporaryDirectory();
...
`,
  ...
  it("should publish the package with yarn", async () => {
    const cwd = temporaryDirectory();
    ...
    await $(
      options,
    )`yarn config set ${`npmScopes["publish-yarn"].npmRegistryServer`} ${registry}`;
  ...
  it("should publish the package with npm", async () => {
    const cwd = temporaryDirectory();
